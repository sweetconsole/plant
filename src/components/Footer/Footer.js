	...
	return (
		<div className="footer">
			<div className="footer-info">
				...
				<a className="footer-networks" href="https://ru-ru.facebook.com/"><img src={Facebook} alt="Facebook" /></a>
				<a className="footer-networks" href="https://ru-ru.facebook.com/"><img src={Twitter} alt="Twitter" /></a>
				<a className="footer-networks" href="https://ru-ru.facebook.com/"><img src={Instagram} alt="Instagram" /></a>		
			</div>
